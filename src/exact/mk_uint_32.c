...
#define mk_uint_small_from_sizet mk_uint16_from_sizet
#define mk_uint_small_to_sizet mk_uint16_to_sizet
#define mk_uint_small_from_buff_le mk_uint16_from_buff_le
#define mk_uint_small_to_buff_be mk_uint16_to_buff_be
