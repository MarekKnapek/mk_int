...
static mk_inline void mk_uint_fuzz_128_from_long(unsigned char const* data)
{
	unsigned long n;
	uint128_t br;
	struct mk_uint128_s mr;
	...
	br = (uint128_t)n;
	mk_uint128_from_long(&mr, n);

	test(memcmp(&br, &mr, 128 / CHAR_BIT) == 0);
}

static mk_inline void mk_uint_fuzz_128_to_long(unsigned char const* data)
{
	uint128_t bx;
	unsigned long br;
	struct mk_uint128_s mx;
...
static mk_inline void mk_uint_fuzz_128_gt(unsigned char const* data)
{
	uint128_t ba;
	uint128_t bb;
	int br;
	...
	memcpy(&ma, data + 0 / CHAR_BIT, 128 / CHAR_BIT);
	memcpy(&mb, data + 128 / CHAR_BIT, 128 / CHAR_BIT);
	mr = mk_uint128_gt(&ma, &mb);

	test(memcmp(&br, &mr, sizeof(br)) == 0);
}

static mk_inline void mk_uint_fuzz_128_ge(unsigned char const* data)
{
	uint128_t ba;
	uint128_t bb;
	int br;
...
static mk_inline void mk_uint_fuzz_128_mul(unsigned char const* data)
{
	uint128_t ba;
	uint128_t bb;
	uint128_t br;
	...
	memcpy(&ma, data + 0 / CHAR_BIT, 128 / CHAR_BIT);
	memcpy(&mb, data + 128 / CHAR_BIT, 128 / CHAR_BIT);
	mk_uint128_mul(&mr, &ma, &mb);

	test(memcmp(&br, &mr, 128 / CHAR_BIT) == 0);
}

static mk_inline void mk_uint_fuzz_128_div(unsigned char const* data)
{
	uint128_t ba;
	uint128_t bb;
	uint128_t br;
	...
	memcpy(&ma, data + 0 / CHAR_BIT, 128 / CHAR_BIT);
	memcpy(&mb, data + 128 / CHAR_BIT, 128 / CHAR_BIT);
	mk_uint128_div(&mr, &ma, &mb);

	test(memcmp(&br, &mr, 128 / CHAR_BIT) == 0);
}

static mk_inline void mk_uint_fuzz_128_mod(unsigned char const* data)
{
	uint128_t ba;
	uint128_t bb;
	uint128_t br;
...
void mk_uint_fuzz_128(unsigned char const* data)
{
	...
	mk_uint_fuzz_128_from_long(data);
	mk_uint_fuzz_128_to_long(data);
	...
	mk_uint_fuzz_128_gt(data);
	mk_uint_fuzz_128_ge(data);
	...
	mk_uint_fuzz_128_mul(data);
	mk_uint_fuzz_128_div(data);
	mk_uint_fuzz_128_mod(data);
}
